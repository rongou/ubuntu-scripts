...
sudo update-alternatives --install /usr/bin/gcc gcc /usr/local/gcc-11.2.0/bin/gcc-11.2 112 --slave /usr/bin/g++ g++ /usr/local/gcc-11.2.0/bin/g++-11.2 --slave /usr/bin/gcov gcov /usr/local/gcc-11.2.0/bin/gcov-11.2
